var CHINESE_REGIONS = {
  ...
  "台湾省": {
    "城市": ["台北市","新北市","桃园市","台中市","台南市","高雄市","基隆市","新竹市","嘉义市","新竹县","苗栗县","彰化县","南投县","云林县","嘉义县","屏东县","宜兰县","花莲县","台东县","澎湖县"],
    "地区": {
      ...
      "桃园市": ["中区","平镇区","龙潭区","杨梅区","新屋区","观音区","桃园区","龟山区","八德区","大溪区","复兴区","大园区","芦竹区"],
      ...
      "基隆市": ["仁爱区","信义区","中正区","中区","安乐区","暖暖区","七堵区"],
      "新竹市": ["东区","北区","香山区"],
      "嘉义市": ["东区","西区"],
      "新竹县": ["竹北市","湖口乡","新丰乡","新埔镇","关西镇","芎林乡","宝山乡","竹东镇","五峰乡","横山乡","尖石乡","北埔乡","峨眉乡"],
      "苗栗县": ["苗栗市","头份市","西湖乡","通霄镇","苑里镇","造桥乡","后龙镇","竹南镇","公馆乡","铜锣乡","三义乡","大湖乡","卓兰镇","南庄乡","头屋乡","三湾乡","狮潭乡","泰安乡"],
...
var PROVINCES = Object.keys(CHINESE_REGIONS);

module.exports = { CHINESE_REGIONS, PROVINCES };
